...
struct AstarConfig{
    bool Euclidean{true};         // true/false
    int OccupyThresh{100};       // 0~255
    double InflateRadius{0.25};      // integer
...
public:
    ...
    vector<Point> PathPlanning(Point _startPoint, Point _targetPoint);
...
private:
    ...
    vector<Point>GetPath_sep(Node* TailNode);
